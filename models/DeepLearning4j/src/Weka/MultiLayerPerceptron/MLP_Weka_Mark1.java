...
public class MLP_Weka_Mark1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int numFolds = 5;
        br = new BufferedReader(new FileReader("C:\\Users\\MAHE\\Desktop\\scientia_sit_potentia\\2.Projects\\1.NeonatalApneaDetection\\Data\\apnea_data_2_allfeaturesunedited.arff"));
        ...
        mlp.setTrainingTime(8000);
       // mlp.setGUI(true);    // Check GUI Implementation
        mlp.setHiddenLayers("42,30,3");
        mlp.setLearningRate(0.01);
        mlp.buildClassifier(trainData);
        Evaluation evaluation = new Evaluation(trainData);
        evaluation.crossValidateModel(mlp, trainData, numFolds, new Random(123456));
        // generate curve
        ...
        System.out.println("\nConfusion Matrix: "+ evaluation.confusionMatrix());
