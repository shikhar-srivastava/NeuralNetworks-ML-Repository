...
public class SOLinearSVM_trainer {
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        Classifier sosvm = new SelfOptimizingLinearLibSVM(1,2);
        sosvm.buildClassifier(data);

        //-----------------#Model is now Trained. Serializing Model: SAVE #--------------------

        ObjectOutputStream oos = new ObjectOutputStream(
            new FileOutputStream("D:/Deeplearning4Java/dl4j_0.4_examples/src/main/java/sys.AutoEncoder.Java_ML/SOSVM/sosvm.bin"));
        oos.writeObject(sosvm);
        oos.flush();
        oos.close();
        ...
        int i = 0;
        for (Instance inst : dataForClassification) {
            predictedClassValue[i] = sosvm.classify(inst);
