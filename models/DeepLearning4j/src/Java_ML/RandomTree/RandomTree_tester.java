...
public class RandomTree_tester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream is = new ObjectInputStream(
            new FileInputStream("D:/Deeplearning4Java/dl4j_0.4_examples/src/main/java/sys.AutoEncoder.Java_ML/RandomTree/rt3.bin"));
        ObjectInputStream ois= (ObjectInputStream) is ;
        Object currentObj=ois.readObject();
        System.out.println(currentObj.getClass());
        Classifier rt = (Classifier)currentObj;
        ois.close();
