 ...
 * Implementation of Nearest Mean Classifier
 * @due credit to: Thomas Abeel for the JAVA ML Library & helper codes
 *
 */
public class NearestMean_tester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream is = new ObjectInputStream(
            new FileInputStream("D:/Deeplearning4Java/dl4j_0.4_examples/src/main/java/sys.AutoEncoder.Java_ML/NearestMean/nm3.bin"));
        ObjectInputStream ois= (ObjectInputStream) is ;
        Object currentObj=ois.readObject();
        System.out.println(currentObj.getClass());
        Classifier nm = (Classifier)currentObj;
        ois.close();
